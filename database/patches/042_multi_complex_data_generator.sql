...
drop procedure if exists sp_generate_multi_complex_business_data$$
create procedure sp_generate_multi_complex_business_data()
begin
    ...
    while v_complex_no <= 4 do
        set v_complex_code = case v_complex_no when 1 then 'hzcc001' when 2 then 'nbcc001' when 3 then 'sxjh001' else 'jxyh001' end;
        set v_prefix = case v_complex_no when 1 then 'hz' when 2 then 'nb' when 3 then 'sx' else 'jx' end;
...
call sp_generate_multi_complex_business_data();
